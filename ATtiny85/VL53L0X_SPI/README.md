...
The firmware located in the `/src` directory enables the **ATtiny85** to communicate with the **VL53L0X Time-of-Flight (ToF) laser sensor** using the **I²C protocol**, and then forward the measured data via **SPI** to a **Raspberry Pi**, which is responsible for processing and analyzing the collected information.
