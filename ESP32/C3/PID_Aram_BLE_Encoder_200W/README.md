# Smart PID Heater for Aram Coffee Maker

## Project Description
This project presents the design of a **smart PID‑controlled heater** for the **Aram coffee maker**.  
The system uses a **200W cartridge heater** as the heat source to warm the water inside the machine, eliminating the need for manual pre‑heating.
